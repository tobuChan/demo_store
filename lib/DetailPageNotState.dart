...
//查看商品详细页面
class DetailPageNotState extends StatefulWidget {
  String? _name;
  double? _price;
  String? _url;
  String? _mealType;

  DetailPageNotState(this._name, this._price, this._url, this._mealType);

  @override
  State<DetailPageNotState> createState() =>
      _DetailPageNotStateState(_name, _price, _url, _mealType);
}

class _DetailPageNotStateState extends State<DetailPageNotState> {
  String? _name;
  double? _price;
  String? _url;
  String? _mealType;
  _DetailPageNotStateState(this._name, this._price, this._url, this._mealType);
  @override
